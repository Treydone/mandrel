...
public class NiftyClient implements Closeable {
	...
	/**
	 * @deprecated Use
	 *             {@link NiftyClient#connectAsync(NiftyClientConnector, Duration, Duration, Duration, Duration, int)}
	 *             .
	 */
	@Deprecated
	public <T extends NiftyClientChannel> ListenableFuture<T> connectAsync(NiftyClientConnector<T> clientChannelConnector, @Nullable Duration connectTimeout,
		...
		return connectAsync(clientChannelConnector, connectTimeout, receiveTimeout, receiveTimeout, sendTimeout, maxFrameSize);
	}
	...
	/**
	 * @deprecated Use
	 *             {@link NiftyClient#connectAsync(NiftyClientConnector, Duration, Duration, Duration, Duration, int, com.google.common.net.HostAndPort)}
	 *             .
	 */
	@Deprecated
	public <T extends NiftyClientChannel> ListenableFuture<T> connectAsync(NiftyClientConnector<T> clientChannelConnector, @Nullable Duration connectTimeout,
			@Nullable Duration receiveTimeout, @Nullable Duration sendTimeout, int maxFrameSize, @Nullable HostAndPort socksProxyAddress) {
		return connectAsync(clientChannelConnector, connectTimeout, receiveTimeout, receiveTimeout, sendTimeout, maxFrameSize, socksProxyAddress);
	}
	...
	/**
	 * @deprecated Use the versions of connectSync that take a client
	 *             {@link Class} and a
	 *             {@link com.facebook.nifty.client.NiftyClientConnector}
	 *             instead (this method acts like such a transport around a
	 *             {@link com.facebook.nifty.client.FramedClientConnector}
	 */
	@Deprecated
	 ...
	 */
	@Deprecated
	public TNiftyClientTransport connectSync(InetSocketAddress addr, @Nullable Duration connectTimeout, @Nullable Duration receiveTimeout,
	...
	@Deprecated
	public TNiftyClientTransport connectSync(InetSocketAddress addr, @Nullable Duration connectTimeout, @Nullable Duration receiveTimeout,
			@Nullable Duration sendTimeout, int maxFrameSize, @Nullable HostAndPort socksProxyAddress) throws TTransportException, InterruptedException {
		...
		if (f.getCause() != null) {
			String message = String.format("unable to connect to %s:%d %s", addr.getHostName(), addr.getPort(), socksProxyAddress == null ? ""
					: "via socks proxy at " + socksProxyAddress);
		...
		throw new TTransportException(String.format("unknown error connecting to %s:%d %s", addr.getHostName(), addr.getPort(), socksProxyAddress == null ? ""
				: "via socks proxy at " + socksProxyAddress));
	}

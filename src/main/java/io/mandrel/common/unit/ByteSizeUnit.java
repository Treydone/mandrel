...
/**
 * A <tt>SizeUnit</tt> represents size at a given unit of granularity and
 * provides utility methods to convert across units. A <tt>SizeUnit</tt> does
 * not maintain size information, but only helps organize and use size

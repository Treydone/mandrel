...
public class JdbcStoreTest {
	...
	private static JdbcStore store;
	...
	public static void before() {
		...
		store.setTableName("data");
		store.add("url", "jdbc:hsqldb:mem:test");
		store.add("username", "sa");
		store.add("driverClassName", "org.hsqldb.jdbcDriver");
		store.init(null);
	}
